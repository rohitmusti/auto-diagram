...
def copying():
    ...
    if (browser == 1):
        ...
        os.system('npm run serve &')
        os.system(headlessCMD)
        os.system('sleep 10 && node ./headless_chrome/screenshot.js && mv ./headless_chrome/output.jpeg ./output.jpeg && killall npm && killall node && killall google-chrome-stable && echo "done"')
